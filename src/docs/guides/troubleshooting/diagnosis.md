...
1. Check [open issues](https://github.com/aaronbamblett/tsumiru/issues).
2. Check [closed issues](https://github.com/aaronbamblett/tsumiru/issues?q=is%3Aissue+is%3Aclosed) in case it's already fixed but not yet released.

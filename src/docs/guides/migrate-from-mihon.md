...
1. Add an extension store under **Settings → Browse → Extension stores** (this needs a reasonably current Suwayomi server; see the [Extension stores guide](/docs/guides/adding-sources)).
